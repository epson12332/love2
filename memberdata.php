...
<form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
  ...
  <p>
    ...
    ：
    <input name="name" type="text" id="name" value="<?php echo $row_Recordset1['D_NAME']; ?>" />
  </p>
  <p>
    <label for="tel">電話：</label>
    <input name="tel" type="text" id="tel" value="<?php echo $row_Recordset1['D_TEL']; ?>" />
  </p>
  <p>
    <label for="email">email:</label>
    <input name="email" type="text" id="email" value="<?php echo $row_Recordset1['D_EMAIL']; ?>" />
  </p>
  <p>
    <label for="add">地址：</label>
    <input name="add" type="text" id="add" value="<?php echo $row_Recordset1['D_ADDRESS']; ?>" />
  </p>
  <p>
